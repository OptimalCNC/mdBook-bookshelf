...
mod tests {
    ...
    #[test]
    fn documentation_ui_runtime_assets_preserve_existing_output_assets() {
        ...
        ui_assets
            .append_documentation_runtime_assets(&mut config)
            .expect("asset config append should succeed");
